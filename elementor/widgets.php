...
class Dlist_SingleCat extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        $atts = [
            'default_directory_type' => $settings['default_types'],
            'directory_type'         => $settings['types'] ? implode( ',', $settings['types'] ) : '',
            'header'                 => $settings['header'],
            'advanced_filter'        => 'yes' === $settings['filter'] ? $settings['filter'] : 'no',
            ...
            'map_height'             => $settings['map_height'],
            'logged_in_user_only'    => $user,
            'redirect_page_url'      => 'yes' === $user ? $settings['link']['url'] : '',
        ];

        wpwax_run_shortcode( 'directorist_category', $atts );
    }
}
...
class Dlist_SingleLoc extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        wpwax_run_shortcode( 'directorist_location', $atts );
    }
}
...
class Dlist_SingleTag extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        wpwax_run_shortcode( 'directorist_tag', $atts );
    }
}
