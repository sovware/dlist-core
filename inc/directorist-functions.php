...
add_action( 'wp_ajax_dlist_remove_listing', 'dlist_remove_listing' );

// Add or Remove favourites.

function dlist_public_add_remove_favorites_all() {
...
add_action( 'wp_ajax_dlist_public_add_remove_favorites', 'dlist_public_add_remove_favorites_all' );
add_action( 'wp_ajax_nopriv_dlist_public_add_remove_favorites', 'dlist_public_add_remove_favorites_all' );

// =========Packages==========*/

function dlist_package_tab() {
	...
	return sprintf( '<li class="%s"><a %s ><i class="la la-money-bill"></i><span> %s </span></a> </li>', esc_html( 'sidebar-dropdown' ), wp_kses_post( $attr ), __( 'Packages', 'dlist-core' ) );
}

add_filter( 'atbdp_package_tab', 'dlist_package_tab' );

// Packages content wrapping attributes

function dlist_dashboard_package_content_div_attributes() {
	 return wp_kses_post( 'class="tab-pane fade" id="active-packages" role="tabpanel" aria-labelledby="v-pills-packages-tab"' );
}

add_filter( 'atbdp_dashboard_package_content_div_attributes', 'dlist_dashboard_package_content_div_attributes' );

// Packages content wrapper

function dlist_before_package_table() {
	?>
	<main class="page-content">
		<div class="container-fluid">
			<div class="page-content-header">
				<h2><?php echo esc_html__( 'Packages', 'dlist-extension' ); ?></h2>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">
							<?php echo esc_html__( 'Packages', 'dlist-extension' ); ?>
						</li>
					</ol>
				</nav>
			</div>
...
add_action( 'atbdp_before_package_table', 'dlist_before_package_table' );

// Packages content wrapper closing

function dlist_after_package_table() {
	echo wp_kses_post( '</div> </main>' );
}

add_action( 'atbdp_after_package_table', 'dlist_after_package_table' );

// ==========Order History==========*/
function dlist_order_history_tab() {
	...
	return sprintf( '<li class="%s"><a %s ><i class="la la-history"></i><span> %s </span></a> </li>', esc_html( 'sidebar-dropdown' ), wp_kses_post( $attr ), __( 'Order History', 'dlist-core' ) );
}

add_filter( 'atbdp_order_history_tab', 'dlist_order_history_tab' );

// Order content wrapping attributes

function dlist_dashboard_orderHistory_content_div_attributes() {
	return wp_kses_post( 'class="tab-pane fade" id="active-history" role="tabpanel" aria-labelledby="v-pills-history-tab"' );
}

add_filter( 'atbdp_dashboard_orderHistory_content_div_attributes', 'dlist_dashboard_orderHistory_content_div_attributes' );

// Order content wrapper and breadcrumb

function dlist_before_order_table() {
	?>
	<main class="page-content">
		<div class="container-fluid">
			<div class="page-content-header">
				<h2><?php echo esc_html__( 'Order History', 'dlist-extension' ); ?></h2>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'dlist-extension' ); ?></a>
						...
						<li class="breadcrumb-item active" aria-current="page">
					<?php echo esc_html__( 'Order History', 'dlist-extension' ); ?>
						</li>
					</ol>
				</nav>
			</div>
...
add_action( 'atbdp_before_order_table', 'dlist_before_order_table' );

// Order content wrapper closing.

function dlist_after_order_table() {
	echo wp_kses_post( '</div> </main>' );
}

add_action( 'atbdp_after_order_table', 'dlist_after_order_table' );
...
function dlist_user_dashboard_tab() {
	$attr = 'id="id="v-pills-chat-tab" data-toggle="pill" href="#active-chat" role="tab" aria-controls="active-chat" aria-selected="false"';
	return sprintf( '<li class="%s"><a %s ><i class="las la-comments"></i><span> %s </span></a> </li>', esc_html( 'sidebar-dropdown' ), wp_kses_post( $attr ), __( 'Chat', 'dlist-core' ) );
}

add_filter( 'dlc_user_dashboard_tab', 'dlist_user_dashboard_tab' );

// Chat content wrapping attributes.

function dlist_live_chat_tab_content_class( $attr ) {
	return wp_kses_post( 'class="tab-pane fade" id="active-chat" role="tabpanel" aria-labelledby="v-pills-chat-tab"' );
}

add_filter( 'dlc_dashboard_content_div_attributes', 'dlist_live_chat_tab_content_class' );

// Chat content wrapper and breadcrumb.

function dlist_dashboard_before_content() {
	?>
	<main class="page-content">
		<div class="container-fluid">
			<div class="page-content-header">
				<h2><?php echo esc_html__( 'Chat', 'dlist-extension' ); ?></h2>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'dlist-extension' ); ?></a>
						...
						<li class="breadcrumb-item active" aria-current="page">
					<?php echo esc_html__( 'Chat History', 'dlist-extension' ); ?>
						</li>
					</ol>
				</nav>
			</div>
...
add_action( 'dlc_dashboard_before_content', 'dlist_dashboard_before_content' );

// Chat content wrapper closing.

function dlist_dashboard_after_content() {
	echo wp_kses_post( '</div> </main>' );
}

add_action( 'dlc_dashboard_after_content', 'dlist_dashboard_after_content' );

// My Booking.

function dlist_my_booking_tab() {
	return sprintf( '<li class="sidebar-dropdown"><a id="b-pills-booking-tab" data-toggle="pill" href="#active-my-booking" role="tab" aria-controls="active-my-booking" aria-selected="false"><i class="lar la-calendar-check"></i><span>%s</span></a></li>', __( 'My Bookings', 'dlist-core' ) );
}

add_filter( 'atbdp_user_dashboard_booking_tab', 'dlist_my_booking_tab' );

// Booking content wrapper.

function dlist_my_booking_content() {
	return wp_kses_post( '<div class="tab-pane fade" id="active-my-booking" role="tabpanel" aria-labelledby="b-pills-booking-tab">' );
}

add_filter( 'atbdp_user_dashboard_booking_content_wrapper', 'dlist_my_booking_content' );

// My Booking content wrapper and breadcrumb.

function dlist_user_dashboard_booking_before_content( $args = '' ) {
	?>
	<main class="page-content">
		<div class="container-fluid">
			<div class="page-content-header">
...
add_action( 'atbdp_user_dashboard_booking_before_content', 'dlist_user_dashboard_booking_before_content' );

// My Booking content wrapper closing.

function dlist_user_dashboard_booking_after_content() {
	echo wp_kses_post( '</div> </main>' );
}

add_action( 'atbdp_user_dashboard_booking_after_content', 'dlist_user_dashboard_booking_after_content' );

// All Booking.

function dlist_all_booking_tab() {
	?>

	<li class="sidebar-dropdown dashboard_booking">
		<a href="#approved-booking" class="sidebar-dropdown-icon">
			<i class="las la-clipboard-list"></i>
			<span> <?php esc_html_e( 'All Bookings', 'dlist-core' ); ?> </span>
		</a>
		<div class="sidebar-submenu">
			<ul class="nav flex-column">
				<li>
					<a class="dlist_dash_submenu" id="ab-pills-active-tab" data-toggle="pill" href="#approved-booking" role="tab" aria-controls="approved-booking" aria-selected="true">
					<?php esc_html_e( 'Approved', 'dlist-core' ); ?>
						<!--<span class = "badge badge-pill badge-success">01</span>-->
					</a>
				</li>

				<li>
					<a id="ab-pills-pending-tab" class="dlist_dash_submenu" data-toggle="pill" href="#pending-booking" role="tab" aria-controls="pending-booking" aria-selected="false">
					<?php esc_html_e( 'Pending', 'dlist-core' ); ?>
						<!--<span class = "badge badge-pill badge-warning">01</span>-->
					</a>
				</li>

				<li>
					<a id="ab-pills-cancelled-tab" class="dlist_dash_submenu" data-toggle="pill" href="#cancelled-booking" role="tab" aria-controls="cancelled-booking" aria-selected="false">
					<?php esc_html_e( 'Cancelled', 'dlist-core' ); ?>
...
add_filter( 'atbdp_user_dashboard_all_bookings_tab', 'dlist_all_booking_tab' );

// Booking approved content wrapper.

function dlist_all_booking_approved() {
	return wp_kses_post( '<div class="tab-pane fade" id="approved-booking" role="tabpanel" aria-labelledby="ab-pills-active-tab">' );
}

add_filter( 'atbdp_user_dashboard_approved_bookings_content_wrapper', 'dlist_all_booking_approved' );

// Booking pending content wrapper.

function dlist_all_booking_pending() {
	return wp_kses_post( '<div class="tab-pane fade" id="pending-booking" role="tabpanel" aria-labelledby="ab-pills-pending-tab">' );
}

add_filter( 'atbdp_user_dashboard_pending_bookings_content_wrapper', 'dlist_all_booking_pending' );

// Booking cancelled content wrapper.

function dlist_all_booking_cancelled() {
	return wp_kses_post( '<div class="tab-pane fade" id="cancelled-booking" role="tabpanel" aria-labelledby="ab-pills-cancelled-tab">' );
}

add_filter( 'atbdp_user_dashboard_cancelled_bookings_content_wrapper', 'dlist_all_booking_cancelled' );

function dlist_booking_confirmation_title() {
	return __( 'Contact Information', 'dlist-core' );
}
add_filter( 'booking_confirmation_title', 'dlist_booking_confirmation_title' );


/*
===========Wallet History==========*/
// wallet tab wrapping attributes.
function wallet_user_dashboard_tab() {
	$attr = 'id="v-pills-wallet-tab" data-toggle="pill" href="#active-wallet" role="tab" aria-controls="active-wallet" aria-selected="false"';
	return sprintf( '<li class="%s"><a %s ><i class="las la-wallet"></i><span> %s </span></a> </li>', esc_html( 'sidebar-dropdown' ), wp_kses_post( $attr ), __( 'wallet', 'dlist-core' ) );
}

add_filter( 'atbdp_user_dashboard_wallet_tab', 'wallet_user_dashboard_tab' );

// wallet content wrapping attributes.
function dlist_wallet_tab_content_class( $attr ) {
	return wp_kses_post( 'class="tab-pane fade" id="active-wallet" role="tabpanel" aria-labelledby="v-pills-wallet-tab"' );
}

add_filter( 'wallet_dashboard_content_div_attributes', 'dlist_wallet_tab_content_class' );

// wallet content wrapper and breadcrumb.
function wallet_dashboard_before_content() {
	?>
	<main class="page-content">
		<div class="container-fluid">
			<div class="page-content-header">
				<h2><?php echo esc_html__( 'wallet', 'dlist-extension' ); ?></h2>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'dlist-extension' ); ?></a>
						...
						<li class="breadcrumb-item active" aria-current="page">
							<?php echo esc_html__( 'wallet History', 'dlist-extension' ); ?>
						</li>
					</ol>
				</nav>
			</div>
...
add_action( 'wallet_dashboard_before_content', 'wallet_dashboard_before_content' );

// wallet content wrapper closing.
function wallet_dashboard_after_content() {
	echo wp_kses_post( '</div> </main>' );
}

add_action( 'wallet_dashboard_after_content', 'wallet_dashboard_after_content' );

// Pricing Plan Change.

function dlist_plan_change_link_in_user_dashboard( $link, $listing_id ) {
	$modal_id = apply_filters( 'atbdp_pricing_plan_change_modal_id', 'atpp-plan-change-modal', $listing_id );
	return sprintf( '<span><a data-target="' . $modal_id . '" class="atpp_change_plan" data-listing_id="%s" href="">%s</a></span>', esc_attr( $listing_id ), esc_html__( 'Change', 'dlist-core' ) );
}

add_filter( 'atbdp_plan_change_link_in_user_dashboard', 'dlist_plan_change_link_in_user_dashboard', 10, 2 );

// payment receipt link.

function dlist_payment_receipt_button_link( $link, $order_id ) {
	...
	if ( 'yes' === $need_post ) {
		...
		if ( 'pending' === $new_l_status ) {
			return $link . '#pending-business';
		} else {
			return $link . '#active-business';
		}
	}
}

add_action( 'atbdp_payment_receipt_button_link', 'dlist_payment_receipt_button_link', 10, 2 );

// Profile.
function dlist_update_user_profile() {
	...
	if ( valid_js_nonce() ) {
		...
		if ( $success ) {
			wp_send_json_success( array( 'message' => esc_html__( 'Profile updated successfully', 'dlist-core' ) ) );
		} else {
			wp_send_json_error( array( 'message' => esc_html__( 'Ops! something went wrong. Try again.', 'dlist-core' ) ) );
		};
	}
	wp_die();
}

add_action( 'wp_ajax_dlist_update_user_profile', 'dlist_update_user_profile' );
...
function dlist_added_class_before_listing_form() {
	echo sprintf( '<div class="%s">', 'col-lg-8 offset-lg-2' );
}
add_action( 'atbdb_before_add_listing_from_wrapper', 'dlist_added_class_before_listing_form' );

// Added class before listing for wrapper*/
function dlist_added_class_after_listing_form() {
	echo '</div>';
}
add_action( 'atbdb_after_add_listing_from_wrapper', 'dlist_added_class_after_listing_form' );

// shboard Pagination for listing.
add_action( 'wp_ajax_user_dashboard_active_listings', 'dlist_user__dashboard_listings_pagination' );
add_action( 'wp_ajax_nopriv_user_dashboard_active_listings', 'dlist_user__dashboard_listings_pagination' );

function dlist_user__dashboard_listings_pagination() {
	if ( ! isset( $_POST['page'] ) ) {
		die();
	}
	...
	for ( $i = $start_loop; $i <= $end_loop; $i++ ) {
		if ( $i === 1 || $i === $no_of_paginations ) {
			continue;
		}
		if ( ( $no_of_paginations <= 5 ) && ( $no_of_paginations == $i ) ) {
			continue;
		}
		$dot_     = (int) $cur_page + 2;
		...
		if ( $cur_page > 4 ) {
			if ( ( $dot__ == $i ) ) {
				$jump           = $i - 5;
				$jump           = $jump < 1 ? 1 : $jump;
				$pag_container .= "<li data-page='" . esc_attr( $jump ) . "' class='atbd-page-jump-back atbd-active' title='" . __( 'Previous 5 Pages', 'dlist-core' ) . "'><i class='la la-ellipsis-h la_d'></i> <i class='la la-angle-double-left la_h'></i></li>";
			}
		}
		if ( $cur_page == $i ) {
		...
		if ( ( $cur_page > 4 ) ) {
			if ( ( $dot_ == $i ) ) {
				...
				$pag_container .= "<li data-page='" . esc_attr( $jump ) . "' class='atbd-page-jump-up atbd-active' title='" . __( 'Next 5 Pages', 'dlist-core' ) . "'><i class='la la-ellipsis-h la_d'></i> <i class='la la-angle-double-right la_h'></i></li>";
			}
		}
	...
	foreach ( $all_listings as $key => $post ) {
		...
		$exp_text  = $never_exp ? esc_html__( 'Never Expires', 'dlist-core' ) : date_i18n( $date_format, strtotime( $exp_date ) );
		?>
		...
		<tr data-expanded="<?php echo ( 0 === $key ) ? esc_html( 'true' ) : ''; ?>" class="listing_id_<?php echo esc_attr( $post->ID ); ?>">
			<td class="dl-title">
				<span class="atbd_footable">
					...
					$image_alt    = function_exists( 'dlist_get_image_alt' ) ? dlist_get_image_alt( $listing_prv_img ) : '';
					echo sprintf( '<a href="#" class="atbd_footable_img"><img src="%s" alt="%s"/></a> ', esc_url( $prv_img_link ), $image_alt );
			...
			<?php if ( is_fee_manager_active() ) { ?>
				<td class="dlist_plane_name dl-plan">
					<?php do_action( 'atbdp_user_dashboard_listings_before_expiration', $listing_id ); ?>
				</td>
			<?php } ?>
			<td class="dl-expired">
				<?php echo ( 'expired' === $l_status ) ? esc_html__( 'Expired', 'dlist-core' ) : esc_attr( $exp_text ); ?>
			</td>

			<td class="dl-status">
				<span class="badge badge-light active"><?php echo esc_html__( 'Active', 'dlist-core' ); ?></span>
			</td>
			...
			<td class="edit_btn_wrap dl-action">
				<div class="action_button">
						...
						if ( is_fee_manager_active() ) {
							...
							?>
								<a href="javascript:void(0)" data-toggle="modal" data-target="<?php echo esc_attr( $modal_id ); ?>" data-listing_id="<?php echo esc_attr( $listing_id ); ?>" class="directory_btn btn btn-outline-success atbdp_renew_with_plan">
									<?php esc_html_e( 'Renew', 'dlist-core' ); ?>
								</a>
							<?php
						} else {
							?>
						...
						if ( $featured_active && empty( $featured ) && ! is_fee_manager_active() ) {
							?>
								<a href="<?php echo esc_url( ATBDP_Permalink::get_checkout_page_link( $listing_id ) ); ?>" id="directorist-promote" data-listing_id="<?php echo esc_attr( $listing_id ); ?>" class="directory_btn btn text-primary">
									<?php esc_html_e( 'Promote Your listing', 'dlist-core' ); ?>
								</a>
							<?php
						}
					}
					...
					<a href="<?php echo esc_url( ATBDP_Permalink::get_edit_listing_page_link( $listing_id ) ); ?>" class="btn text-primary">
						<?php esc_html_e( ' Edit', 'dlist-core' ); ?>
					</a>

					<a href="listing-del" id="dlist_remove_listing" data-listing_id="<?php echo esc_attr( $listing_id ); ?>" class="directory_remove_btn text-danger">
						<?php esc_html_e( 'Delete', 'dlist-core' ); ?>
					</a>
				</div>
				...
				<div class="responsive_dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						...
						<a href="#" id="dlist_remove_listing" data-listing_id="<?php echo esc_attr( $listing_id ); ?>" class="directory_remove_btn btn text-danger">
						<?php esc_html_e( 'Delete', 'dlist-core' ); ?>
						</a>
					</div>
				</div>
...
// shboard Pagination for need listing
	add_action( 'wp_ajax_user_dashboard_active_needs', 'dlist_user__dashboard_needs_pagination' );
add_action( 'wp_ajax_nopriv_user_dashboard_active_needs', 'dlist_user__dashboard_needs_pagination' );

function dlist_user__dashboard_needs_pagination() {
	if ( ! isset( $_POST['page'] ) ) {
		die();
	}
	// Sanitize the received page
	...
	foreach ( $all_needs as $key => $post ) {
		...
		<tr data-expanded="<?php echo ( 0 === $key ) ? esc_html( 'true' ) : ''; ?>" class="listing_id_<?php echo esc_attr( $post->ID ); ?>">
			...
			if ( is_fee_manager_active() ) {
				?>
				<td class="dlist_plane_name dn-plan">
					<?php do_action( 'atbdp_user_dashboard_listings_before_expiration', $listing_id ); ?>
				</td>
				<?php
			}
			...
			<td class="edit_btn_wrap dn-action">
				...
				?>
					...
					<a href="listing-del" id="dlist_remove_listing" data-listing_id="<?php echo esc_attr( $listing_id ); ?>" class="directory_remove_btn btn text-danger">
						<?php esc_html_e( 'Delete', 'dlist-core' ); ?>
					</a>
				</div>
				...
				<div class="responsive_dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						...
						<a href="#" id="dlist_remove_listing" data-listing_id="<?php echo esc_attr( $post->ID ); ?>" class="directory_remove_btn btn btn-outline-danger">
						<?php esc_html_e( 'Delete', 'dlist-core' ); ?>
						</a>
					</div>
				</div>
...
function dlist_single_listing_tag_icon() {
	return atbdp_icon_type() . '-list-alt';
}

add_filter( 'atbdp_single_listing_tag_icon', 'dlist_single_listing_tag_icon' );

// added single listing tags icon
function dlist_single_listing_tags_icon() {
	 return atbdp_icon_type() . '-check-square';
}

add_filter( 'atbdp_single_listing_tags_icon', 'dlist_single_listing_tags_icon' );
...
function need_count( $html, $term ) {
	...
	if ( 1 < $total ) {
		return sprintf( '<span>%s</span>', esc_attr( $total ) . __( ' Listings', 'dlist-core' ) );
	} else {
		return sprintf( '<span>%s</span>', esc_attr( $total ) . __( ' Listing', 'dlist-core' ) );
	}
}
