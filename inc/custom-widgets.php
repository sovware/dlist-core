                ...
                <div class="widget-content">
                    <div class="subscribe-widget">
                        <form action="<?php echo esc_url($form); ?>" method="post">
                            ...
                            <button class="submit-btn" type="submit"><?php class_exists( 'Directorist_Base' ) ? directorist_icon( 'las la-paper-plane' ) : ''; ?></button>
                        </form>
                    </div>
                </div>
            </div>
                                ...
                                if ($link_text): ?>
                                    <li>
                                        <a href="<?php echo esc_url($link_url); ?>" class="<?php echo esc_attr($link_text) ?>">
                                            <?php class_exists( 'Directorist_Base' ) ? directorist_icon( 'fab fa-' . $link_text ) : ''; ?>
                                        </a>
                                    </li>
                                <?php endif;
            ...
            <div class="search-widget">
                <form role="search" method="get" action="<?php echo esc_url(home_url()); ?>">
                    <div class="input-group">
                        ...
                        <button value="search" type="submit"><?php class_exists( 'Directorist_Base' ) ? directorist_icon( 'las la-search' ) : ''; ?></button>
                    </div>
                </form>
            </div>
        </div>
